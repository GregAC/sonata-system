...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_28_ds_h2d [26];
  tl_d2h_t tl_s1n_28_ds_d2h [26];
  ...
  assign tl_hyperram_o = tl_s1n_28_ds_h2d[1];
  assign tl_s1n_28_ds_d2h[1] = tl_hyperram_i;

  assign tl_rev_tag_o = tl_s1n_28_ds_h2d[2];
  assign tl_s1n_28_ds_d2h[2] = tl_rev_tag_i;

  assign tl_gpio_o = tl_s1n_28_ds_h2d[3];
  assign tl_s1n_28_ds_d2h[3] = tl_gpio_i;

  assign tl_pwm_o = tl_s1n_28_ds_h2d[4];
  assign tl_s1n_28_ds_d2h[4] = tl_pwm_i;

  assign tl_rpi_gpio_o = tl_s1n_28_ds_h2d[5];
  assign tl_s1n_28_ds_d2h[5] = tl_rpi_gpio_i;

  assign tl_ard_gpio_o = tl_s1n_28_ds_h2d[6];
  assign tl_s1n_28_ds_d2h[6] = tl_ard_gpio_i;

  assign tl_pmod_gpio_o = tl_s1n_28_ds_h2d[7];
  assign tl_s1n_28_ds_d2h[7] = tl_pmod_gpio_i;

  assign tl_timer_o = tl_s1n_28_ds_h2d[8];
  assign tl_s1n_28_ds_d2h[8] = tl_timer_i;

  assign tl_rgbled_ctrl_o = tl_s1n_28_ds_h2d[9];
  assign tl_s1n_28_ds_d2h[9] = tl_rgbled_ctrl_i;

  assign tl_uart0_o = tl_s1n_28_ds_h2d[10];
  assign tl_s1n_28_ds_d2h[10] = tl_uart0_i;

  assign tl_uart1_o = tl_s1n_28_ds_h2d[11];
  assign tl_s1n_28_ds_d2h[11] = tl_uart1_i;

  assign tl_uart2_o = tl_s1n_28_ds_h2d[12];
  assign tl_s1n_28_ds_d2h[12] = tl_uart2_i;

  assign tl_uart3_o = tl_s1n_28_ds_h2d[13];
  assign tl_s1n_28_ds_d2h[13] = tl_uart3_i;

  assign tl_uart4_o = tl_s1n_28_ds_h2d[14];
  assign tl_s1n_28_ds_d2h[14] = tl_uart4_i;

  assign tl_i2c0_o = tl_s1n_28_ds_h2d[15];
  assign tl_s1n_28_ds_d2h[15] = tl_i2c0_i;

  assign tl_i2c1_o = tl_s1n_28_ds_h2d[16];
  assign tl_s1n_28_ds_d2h[16] = tl_i2c1_i;

  assign tl_spi_flash_o = tl_s1n_28_ds_h2d[17];
  assign tl_s1n_28_ds_d2h[17] = tl_spi_flash_i;

  assign tl_spi_lcd_o = tl_s1n_28_ds_h2d[18];
  assign tl_s1n_28_ds_d2h[18] = tl_spi_lcd_i;

  assign tl_spi_eth_o = tl_s1n_28_ds_h2d[19];
  assign tl_s1n_28_ds_d2h[19] = tl_spi_eth_i;

  assign tl_spi_rp0_o = tl_s1n_28_ds_h2d[20];
  assign tl_s1n_28_ds_d2h[20] = tl_spi_rp0_i;

  assign tl_spi_rp1_o = tl_s1n_28_ds_h2d[21];
  assign tl_s1n_28_ds_d2h[21] = tl_spi_rp1_i;

  assign tl_spi_ard_o = tl_s1n_28_ds_h2d[22];
  assign tl_s1n_28_ds_d2h[22] = tl_spi_ard_i;

  assign tl_spi_mkr_o = tl_s1n_28_ds_h2d[23];
  assign tl_s1n_28_ds_d2h[23] = tl_spi_mkr_i;

  assign tl_asf_30_us_h2d = tl_s1n_28_ds_h2d[24];
  assign tl_s1n_28_ds_d2h[24] = tl_asf_30_us_d2h;

  assign tl_rv_plic_o = tl_s1n_28_ds_h2d[25];
  assign tl_s1n_28_ds_d2h[25] = tl_rv_plic_i;

  assign tl_sm1_29_us_h2d[1] = tl_dbg_host_i;
  assign tl_dbg_host_o = tl_sm1_29_us_d2h[1];

  assign tl_s1n_28_us_h2d = tl_ibex_lsu_i;
  assign tl_ibex_lsu_o = tl_s1n_28_us_d2h;

  assign tl_sram_o = tl_sm1_29_ds_h2d;
  assign tl_sm1_29_ds_d2h = tl_sram_i;
